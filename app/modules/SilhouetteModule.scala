...
import models.services.{ BCryptPasswordHasherWithSaltShow, UserService, UserServiceImpl }
...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  def configure() {
    ...
    bind[PasswordHasher].toInstance(new BCryptPasswordHasherWithSaltShow)
  ...
  def provideAuthenticatorService(
    ...
    //AuthenticatorRepository[JWTAuthenticator]
